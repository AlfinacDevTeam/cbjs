class ChatBot extends HTMLElement {
    ...
    this.shadowRoot.innerHTML = `
            ...
            <div class="chat-container" style="z-index: 9999999999;" id="chatContainer">
                ...
                <div class="chat-input">
                    <input id="messageInput" maxlength="200" placeholder="Write your question to ai chatbot here"/>
                    <button id="sendBtn">
                        <svg
                            ...
                            width="24"
                            fill="white"
                            style="transform: scale(1.2) translateX(2px) translateY(-2px) rotate(-35deg);"
                        >
  ...
  async sendMessage() {
    ...
    const message = input.value.trim() || this.messageFirst;
    if (!message) return;

    if (window.ReactNativeWebView?.postMessage) {
      window.ReactNativeWebView.postMessage(
        "📬 sendMessage: " + this.messageFirst
      );
    }
